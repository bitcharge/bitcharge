ADMIN_EMAIL = 'admin@myexchangepea.dev'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@myexchangepea.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@myexchangepea.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
