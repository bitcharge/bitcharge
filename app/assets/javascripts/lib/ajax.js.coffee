MyexchangepeaModel = @MyexchangepeaModel or require('myexchangepea_model')
$      = MyexchangepeaModel.$
Model  = MyexchangepeaModel.Model
Queue  = $({})
...
class Singleton extends Base
  ...
  recordResponse: (options = {}) =>
    (data, status, xhr) =>
      ...
      Ajax.disable =>
        unless MyexchangepeaModel.isBlank(data) or @record.destroyed
